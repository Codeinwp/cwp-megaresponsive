...
function cwp_megar_customize_register( $wp_customize ) {	class megaresponsive_lite_Theme_Support extends WP_Customize_Control	{		public function render_content()		{		}	} 
	...
	$wp_customize->add_setting( 'megaresponsive_lite_logo' );
